...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Changa:wght@200;300;400;500;600;700;800&display=swap"
        rel="stylesheet">
    <!-- Css Files -->
    <link rel="stylesheet" href="css/style.css"> <!-- General Styling -->
    ...
    <link rel="stylesheet" href="css/map.css"> <!-- 6- Map Section -->
    <link rel="stylesheet" href="css/contact.css"> <!-- 7- Contact Section -->
    <link rel="stylesheet" href="css/footer.css"> <!-- 8- Footer Section -->
...
<body>
    ...
    <section class="meal-categories pd-y" style="padding-bottom: 0px;" id="r-meals">
        <div class="container" style="width: 90%;">
            <aside class="categories">
                ...
                <div class="get-category">
                    ...
                    <div>
                        <?php
                                // it can be solved by pure sql but we are here in php not sql ^_^
                    ...
                    while ($rowCategories=mysqli_fetch_assoc($dataCategories)) { // 2
                        ...
                        if (mysqli_num_rows($dataMeals)>0) {
                            ...
                            while ($rowMeals=mysqli_fetch_assoc($dataMeals)) {
                                echo "<div class ='lunch-item' style='margin-bottom: 20px; float:right;'>
                                <a href='#'><img src='images/meals/".$rowMeals['meal_image']."' alt='Potato ! :D' draggable='false'></a>
                                <div class='lunch-item-description'>
                                <div>";
    ...
    <section class="contact" id="contact">
        ...
        <div class="container">
            ...
            <div class="quick-links">
                ...
                <a href="#meals"><i class="fa fa-check-circle"></i>&nbsp;الوجبات الرئيسية</a>
                <a href="#r-meals"><i class="fa fa-check-circle"></i>&nbsp;أصناف الطعام</a>
